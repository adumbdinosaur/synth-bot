...
class CustomPowerMessagesManager(BaseDatabaseManager):
    ...
    @retry_db_operation()
    async def add_custom_power_message(
    ...
    @retry_db_operation()
    async def get_user_custom_power_messages(
        self, user_id: int
    ) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(
                f"Error fetching custom power messages for user {user_id}: {e}"
            )
            return []
    ...
    async def get_active_custom_power_messages(self, user_id: int) -> List[str]:
        ...
        try:
            ...
            logger.error(
                f"Error fetching active custom power messages for user {user_id}: {e}"
            )
            return []
    ...
    async def update_custom_power_message(
        ...
        try:
            ...
            logger.error(
                f"Error updating custom power message {message_id} for user {user_id}: {e}"
            )
            return {"success": False, "error": str(e)}
    ...
    async def toggle_custom_power_message(
        ...
        try:
            ...
            logger.error(
                f"Error toggling custom power message {message_id} for user {user_id}: {e}"
            )
            return {"success": False, "error": str(e)}

    @retry_db_operation()
    async def delete_custom_power_message(
        ...
        try:
            ...
            logger.error(
                f"Error deleting custom power message {message_id} for user {user_id}: {e}"
            )
            return {"success": False, "error": str(e)}
    ...
    async def get_custom_power_message_count(self, user_id: int) -> Dict[str, int]:
        ...
        try:
            ...
            logger.error(
                f"Error getting custom power message count for user {user_id}: {e}"
            )
