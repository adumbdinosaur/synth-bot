...
async def admin_toggle_user_admin(
    ...
    try:
        ...
        if success:
            logger.info(f"Admin {current_user['username']} toggled admin status for user {user_id}")
            return RedirectResponse(
...
async def admin_delete_user(
    ...
    try:
        ...
        if success:
            logger.info(f"Admin {current_user['username']} deleted user {user_info['username']} (ID: {user_id})")
            return RedirectResponse(
...
async def admin_create_admin(
    ...
    try:
        ...
        logger.info(f"Admin {current_user['username']} created new admin user {username} (ID: {user_id})")
        return RedirectResponse(
